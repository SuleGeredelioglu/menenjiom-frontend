                  ...
                  onPressed: _isAnalyzing
                      ...
                      : () async {
                          ...
                          if (result != null &&
                            ...
                            var aiResponse =
                                await _apiService.analyzeMri(1, filePath);

                            setState(() {
                              _isAnalyzing = false;
                              if (aiResponse != null &&
                                  aiResponse.containsKey('message')) {
                                try {
                                  var data = aiResponse['data'];
                                  var vols = data['volumes_cm3'] ??
                                      data['Volumes_cm3'];

                                  if (data['mask_file_path'] != null) {
                                    _maskFilePath = Uri.encodeComponent(
                                        data['mask_file_path'].toString());
                                  }

                                  if (vols != null) {
                                    _analysisResult = "TÜMÖR TESPİT EDİLDİ\n\n"
                                    ...
                                    _analysisResult =
                                        "Veri alındı ama hacimler ayrıştırılamadı.";
                                  }
                                } catch (e) {
